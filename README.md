...
This project is ready to run as a static website. Open `portfolio 2 .html` in a browser to view the portfolio locally.

> Tip: If you want to publish this with GitHub Pages, rename `portfolio 2 .html` to `index.html` so GitHub can load the homepage automatically.
...
3. Open `portfolio 2 .html` in your browser.
...
1. Rename `portfolio 2 .html` to `index.html`.
2. Push the project to GitHub.
3. Open the repository settings.
4. Go to **Pages**.
5. Set the source branch to `main` and the folder to `/ (root)`.
6. Save the settings and wait for GitHub to generate the live URL.
...
- Rename the HTML file to `index.html` if you want a clean public homepage.
